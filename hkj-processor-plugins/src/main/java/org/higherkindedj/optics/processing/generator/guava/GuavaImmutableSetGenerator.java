...
public final class GuavaImmutableSetGenerator extends BaseGuavaSingleIterableTraversableGenerator {
  ...
  public boolean supports(final TypeMirror type) {
    ...
    return element.toString().equals(IMMUTABLE_SET.canonicalName());
  }
