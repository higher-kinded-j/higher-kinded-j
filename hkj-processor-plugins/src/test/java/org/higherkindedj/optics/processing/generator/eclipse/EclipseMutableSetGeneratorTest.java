...
public class EclipseMutableSetGeneratorTest {
  @Test
  @DisplayName("should generate correct traversal for MutableSet fields")
  void shouldGenerateCorrectTraversal() {
    final var sourceFile =
        JavaFileObjects.forSourceString(
            ...
            @GenerateTraversals
            public record Article(long id, MutableSet<String> keywords) {}
            """);
    ...
    final String expectedBody =
        ...
        final var effectOfConvertBack = applicative.map(newList -> Sets.mutable.ofAll(newList), effectOfList);
