...
public class EclipseImmutableBagGeneratorTest {
  @Test
  @DisplayName("should generate correct traversal for ImmutableBag fields")
  void shouldGenerateCorrectTraversal() {
    final var sourceFile =
        JavaFileObjects.forSourceString(
            ...
            @GenerateTraversals
            public record Article(long id, ImmutableBag<String> keywords) {}
            """);
