  ...
  void shouldGenerateCorrectTraversal() {
    final var sourceFile =
        JavaFileObjects.forSourceString(
            ...
            """
                        ...
                        @GenerateTraversals
                        public record Article(long id, UnmodifiableList<String> keywords) {}
                        """);
    ...
    final String expectedBody =
        """
                ...
                final var effectOfConvertBack = applicative.map(newList -> new UnmodifiableList<>(newList), effectOfList);
