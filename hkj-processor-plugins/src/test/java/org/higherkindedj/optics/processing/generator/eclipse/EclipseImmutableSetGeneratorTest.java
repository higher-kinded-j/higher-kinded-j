...
public class EclipseImmutableSetGeneratorTest {
  @Test
  @DisplayName("should generate correct traversal for ImmutableSet fields")
  void shouldGenerateCorrectTraversal() {
    ...
    final String expectedBody =
        ...
        final var effectOfConvertBack = applicative.map(newList -> Sets.immutable.ofAll(newList), effectOfList);
