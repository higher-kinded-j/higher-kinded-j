...
public class EclipseMutableSortedSetGeneratorTest {
  @Test
  @DisplayName("should generate correct traversal for MutableSortedSet fields")
  void shouldGenerateCorrectTraversal() {
    final var sourceFile =
        JavaFileObjects.forSourceString(
            ...
            @GenerateTraversals
            public record Article(long id, MutableSortedSet<String> keywords) {}
            """);
    ...
    final String expectedBody =
        ...
        final var effectOfConvertBack = applicative.map(newList -> Objects.isNull(source.keywords().comparator()) ? SortedSets.mutable.ofAll(newList) : SortedSets.mutable.ofAll(source.keywords().comparator(), newList), effectOfList);
