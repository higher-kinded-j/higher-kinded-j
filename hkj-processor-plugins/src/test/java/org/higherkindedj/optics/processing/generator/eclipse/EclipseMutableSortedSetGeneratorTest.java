...
public class EclipseMutableSortedSetGeneratorTest {
  ...
  void shouldGenerateCorrectTraversal() {
    ...
    final String expectedBody =
        ...
        final var effectOfSet = applicative.map(newList -> Objects.isNull(source.keywords().comparator()) ? SortedSets.mutable.ofAll(newList) : SortedSets.mutable.ofAll(source.keywords().comparator(), newList), effectOfList);
