...
public class ApacheHashBagGeneratorTest {
  @Test
  @DisplayName("should generate correct traversal for HashBag fields")
    ...
    final var sourceFile =
        JavaFileObjects.forSourceString(
            ...
            """
                        ...
                        @GenerateTraversals
                        public record Article(long id, HashBag<String> keywords) {}
                        """);
