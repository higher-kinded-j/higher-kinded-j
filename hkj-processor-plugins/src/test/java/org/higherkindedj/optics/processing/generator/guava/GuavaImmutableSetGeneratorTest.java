...
public class GuavaImmutableSetGeneratorTest {
  @Test
  @DisplayName("should generate correct traversal for Guava ImmutableSet fields")
  void shouldGenerateCorrectTraversal() {
    final var sourceFile =
        JavaFileObjects.forSourceString(
            ...
            @GenerateTraversals
            public record Article(long id, ImmutableSet<String> keywords) {}
            """);
    ...
    final String expectedBody =
        ...
        final var effectOfConvertBack = applicative.map(newList -> ImmutableSet.copyOf(newList), effectOfList);
