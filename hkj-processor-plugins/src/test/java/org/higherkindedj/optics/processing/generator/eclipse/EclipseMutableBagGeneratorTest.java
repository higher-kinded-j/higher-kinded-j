...
public class EclipseMutableBagGeneratorTest {
  @Test
  @DisplayName("should generate correct traversal for MutableBag fields")
  void shouldGenerateCorrectTraversal() {
    final var sourceFile =
        JavaFileObjects.forSourceString(
            ...
            @GenerateTraversals
            public record Article(long id, MutableBag<String> keywords) {}
            """);
    ...
    final String expectedBody =
        ...
        final var effectOfConvertBack = applicative.map(newList -> Bags.mutable.ofAll(newList), effectOfList);
