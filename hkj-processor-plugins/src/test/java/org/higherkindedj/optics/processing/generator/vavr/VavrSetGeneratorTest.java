...
public class VavrSetGeneratorTest {
  @Test
  @DisplayName("should generate correct traversal for Vavr Set fields")
  void shouldGenerateCorrectTraversal() {
    ...
    final String expectedBody =
        ...
        final var effectOfConvertBack = applicative.map(newList -> HashSet.ofAll(newList), effectOfList);
