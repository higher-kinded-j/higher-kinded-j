...
public class Tutorial02_EffectPathAdvanced {
  ...
  void exercise2_forPathWithEither() {
    ...
    // Note: The lambda for each subsequent `.from()` call receives a tuple of the previously bound
    // values.
  ...
  void exercise3_errorContext() {
    ...
    // TODO: Replace null with ErrorContext.success(42)
    ErrorContext<?, String, Integer> success = answerRequired();

    // TODO: Replace null with ErrorContext.failure("Something went wrong")
  ...
  void exercise4_configContext() {
    ...
    // TODO: Replace null with ConfigContext.ask()
    ...
    //     .via(endpoint -> ConfigContext.<AppConfig, String>io(cfg ->
    //         endpoint + "?timeout=" + cfg.timeout()))
  ...
  void exercise6_generatePathBridgePattern() {
    ...
    // TODO: Replace null with: id -> Path.optional(findById.apply(id))
  ...
  void exercise7_focusEffectIntegration() {
    ...
    // TODO: Replace null with userPath.focus(addressPath).focus(cityPath)
