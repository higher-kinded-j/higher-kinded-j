 ...
 *
 * <p>This file contains complete, working solutions for all exercises in Tutorial02_LensComposition.
 */
public class Tutorial02_LensComposition_Solution {
  ...
  void exercise5_reusableComposedLenses() {
    ...
    Application app =
        new Application(
            "MyApp", new Database("mydb", new Config("localhost", 5432)));
   ...
   *
   * <p>SOLUTION: with* methods provide nested update helpers (Note: Implementation depends on generated code)
   */
  @Test
