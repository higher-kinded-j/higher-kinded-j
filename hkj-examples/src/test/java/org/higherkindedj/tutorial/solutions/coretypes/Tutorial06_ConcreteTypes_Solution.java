...
public class Tutorial06_ConcreteTypes_Solution {
  ...
  void exercise5_validatedAccumulatesErrors() {
    ...
    Function<String, Validated<String, String>> validateEmail =
        email ->
            email.contains("@") ? Validated.valid(email) : Validated.invalid("Invalid email");
  ...
  void exercise6_convertingTypes() {
    ...
    Either<String, String> either1 = present.isJust()
        ? Either.right(present.get())
        : Either.left("Not found");
    Either<String, String> either2 = absent.isJust()
        ? Either.right(absent.get())
        : Either.left("Not found");
