...
public class Tutorial02_FunctorMapping_Solution {
  ...
  void exercise1_mapEither() {
    ...
    // SOLUTION: Use map to convert Integer to String
    Either<String, String> result = either.map(i -> String.valueOf(i));
  ...
  void exercise2_mapDoesNotAffectLeft() {
    ...
    // SOLUTION: The function is never called because this is a Left
    // We can return any String value here
    Either<String, String> result = error.map(i -> String.valueOf(i));
  ...
  void exercise3_mapList() {
    ...
    // SOLUTION: Use monad.map to double each number
  ...
  void exercise4_chainingMaps() {
    ...
    // SOLUTION: Chain map operations
    // 1. Multiply by 2 (10 -> 20)
    // 2. Add 5 (20 -> 25)
    // 3. Convert to String (25 -> "25")
    Either<String, String> result =
        value.map(x -> x * 2).map(x -> x + 5).map(x -> String.valueOf(x));
  ...
  void exercise5_functorTypeclass() {
    ...
    // SOLUTION: Return a formatted string with the value
  ...
  void exercise6_methodReferences() {
    ...
    // SOLUTION: Use String::toUpperCase method reference
