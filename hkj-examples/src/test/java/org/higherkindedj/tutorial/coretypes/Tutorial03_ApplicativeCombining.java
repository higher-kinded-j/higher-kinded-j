 ...
 * combines 2/3/4/5 independent values - Perfect for validation where you want to collect all
 * errors
 *
...
public class Tutorial03_ApplicativeCombining {
   ...
   *
   * <p>You now understand: ✓ How to lift values into context with 'of' ✓ How to combine
   * independent values with map2/map3/map4/map5 ✓ That Applicative operations don't depend on
   * previous results ✓ How to validate forms with multiple fields ✓ The difference between Either
   * (fail-fast) and Validated (accumulate errors)
   *
