...
public class TraversalUsageExample {
  ...
  public static void main(String[] args) {
    ...
    private static void selectiveConditionalUpdate() {
        ...
        Kind<Id.Witness, League> updated = leagueToAllPlayerScores.modifyIf(
                isHighScorer,
    ...
    private static void selectiveBranchingUpdate() {
        ...
        var team = new Team("Mixed Team", List.of(
        ...
        Kind<Id.Witness, League> updated = scoreTraversal.branch(
                isExpert,
