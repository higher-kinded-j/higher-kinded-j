...
/**
 * Demonstrates performance characteristics of Selective vs Applicative approaches.
 * Shows operation counting to illustrate when Selective provides benefits.
 */
public class SelectivePerformanceExample {
    ...
    /**
     * Example 1: Short-circuit processing
     * Selective can stop early, Applicative must process all elements.
     */
    private static void shortCircuitComparison() {
        ...
        Kind<Id.Witness, List<Item>> applicativeResult = Traversals.traverseList(
                items,
                item -> {
        ...
        Kind<Id.Witness, List<Item>> selectiveResult = Traversals.traverseListUntil(
                items,
    ...
    private static void conditionalProcessingComparison() {
        ...
        Batch batch = new Batch("Mixed Batch", List.of(
                new Item("ITEM-001", true, 10),
        ...
        Kind<Id.Witness, Batch> allProcessed = itemsTraversal.modifyF(
                item -> {
                    operationCount.incrementAndGet();
        ...
        Kind<Id.Witness, Batch> selectiveProcessed = itemsTraversal.modifyIf(
     ...
     * Show how selective makes branching more explicit.
     */
