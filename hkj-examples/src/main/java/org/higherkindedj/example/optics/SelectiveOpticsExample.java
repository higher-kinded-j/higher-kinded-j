...
/**
 * Comprehensive example demonstrating Selective functor enhancements to optics.
 * Shows conditional modifications, branching logic, and performance optimizations.
 */
public class SelectiveOpticsExample {
    ...
    /**
     * Example 1: Conditional Lens Updates
     * Only update a field when a condition is met.
     */
    private static void conditionalLensExample() {
        ...
        Kind<Id.Witness, UserLogin> result = attemptsLens.modifyWhen(
                belowThreshold,
                attempts -> attempts + 1,
                userLogin,
        ...
        Kind<Id.Witness, UserLogin> noChange = attemptsLens.modifyWhen(
                belowThreshold,
                attempts -> attempts + 1,
                maxedUserLogin,
                IdSelective.instance()
    ...
    /**
     * Example 2: Branching Lens Logic
     * Apply different modifications based on current value.
     */
    private static void branchingLensExample() {
        ...
        Kind<Id.Witness, Account> positive = balanceLens.modifyBranch(
                isPositive,
        ...
        Kind<Id.Witness, Account> negative = balanceLens.modifyBranch(
                isPositive,
    ...
    private static void conditionalTraversalExample() {
        ...
        Kind<Id.Witness, Bank> updated = accountsTraversal.modifyIf(
                isPremium,
                account -> Id.of(AccountLenses.balance().modify(
     ...
     * Both branches visible upfront - can potentially execute in parallel.
     */
    private static void speculativeTraversalExample() {
        ...
        Kind<Id.Witness, List<Double>> results = Traversals.speculativeTraverseList(
                accounts,
                Account::isPremium,
                premiumCalculation,
                standardCalculation,
    ...
    /**
     * Example 5: Short-Circuit Processing
    ...
    private static void shortCircuitExample() {
        ...
        Kind<Id.Witness, List<Account>> results = Traversals.traverseListUntil(
                accounts,
                isOverdrawn,
                account -> {
    ...
    /**
     * Example 6: Comparative Example - Applicative vs Selective
     * Shows the difference in validation approaches.
     */
    private static void comparativeExample() {
        System.out.println("--- Example 6: Applicative vs Selective Comparison ---");

        Bank bank = new Bank("Test Bank", List.of(
                new Account("ACC-001", 1000.0, false),
       ...
       Function<Account, Kind<ValidatedKind.Witness<String>, Account>> validator =
        ...
        Validated<String, Bank> applicativeResult = VALIDATED.narrow(
        ...
        Validated<String, Bank> selectiveResult = VALIDATED.narrow(
