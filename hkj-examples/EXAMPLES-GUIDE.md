...
| [EnhancedOpticsIntegrationExample.java](src/main/java/org/higherkindedj/example/basic/expression/EnhancedOpticsIntegrationExample.java) | Demonstrates Phase 6 enhanced optics: traverseOver, modifyThrough, modifyVia, updateVia, through(Iso) | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.basic.expression.EnhancedOpticsIntegrationExample` | [Optics in Comprehensions](https://higher-kinded-j.github.io/latest/functional/for_optics.html) |
