...
| [EitherOrBothExample.java](src/main/java/org/higherkindedj/example/basic/eitherorboth/EitherOrBothExample.java) | Demonstrates EitherOrBoth (inclusive-or) for "success with warnings" | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.basic.eitherorboth.EitherOrBothExample` | [EitherOrBoth](https://higher-kinded-j.github.io/latest/monads/either_or_both_monad.html) |
...
| [GeneratedAssemblyExample.java](src/main/java/org/higherkindedj/example/basic/validated/GeneratedAssemblyExample.java) | @GenerateAssembly per-record companions: auto-labelled, order-enforcing, no arity ceiling | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.basic.validated.GeneratedAssemblyExample` | [Accumulating Assembly](https://higher-kinded-j.github.io/latest/monads/validated_assembly.html) |
| [ValidatedAssemblyExample.java](src/main/java/org/higherkindedj/example/basic/validated/ValidatedAssemblyExample.java) | Open-arity accumulating assembly: fields()/accumulate() with located errors | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.basic.validated.ValidatedAssemblyExample` | [Accumulating Assembly](https://higher-kinded-j.github.io/latest/monads/validated_assembly.html) |
...
| [ForTraverseComprehensionExample.java](src/main/java/org/higherkindedj/example/basic/expression/ForTraverseComprehensionExample.java) | Demonstrates traverse(), sequence(), and flatTraverse() within For and ForPath comprehension chains | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.basic.expression.ForTraverseComprehensionExample` | [For Comprehension](https://higher-kinded-j.github.io/latest/functional/for_comprehension.html) |
...
| [EnhancedOpticsIntegrationExample.java](src/main/java/org/higherkindedj/example/basic/expression/EnhancedOpticsIntegrationExample.java) | Demonstrates enhanced optics: traverseOver, modifyThrough, modifyVia, updateVia, through(Iso) | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.basic.expression.EnhancedOpticsIntegrationExample` | [Optics in Comprehensions](https://higher-kinded-j.github.io/latest/functional/for_optics.html) |
...
| [UpdateMonoidExample.java](src/main/java/org/higherkindedj/example/basic/monoid/UpdateMonoidExample.java) | Demonstrates Update and Monoids.update(): named, reusable transformations folded into pipelines, with identity slots for sparse updates | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.basic.monoid.UpdateMonoidExample` | [Semigroup and Monoid](https://higher-kinded-j.github.io/latest/functional/semigroup_and_monoid.html) |
...
| [EitherOrBothPathExample.java](src/main/java/org/higherkindedj/example/effect/EitherOrBothPathExample.java) | Success-with-warnings railway: via accumulation, zipWithAccum, recovery | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.effect.EitherOrBothPathExample` | [EitherOrBothPath](https://higher-kinded-j.github.io/latest/effect/path_either_or_both.html) |
...
| Example | Description | Run Command | Documentation |
|---------|-------------|-------------|---------------|
| [EffectContextExample.java](src/main/java/org/higherkindedj/example/effect/EffectContextExample.java) | Demonstrates Effect Contexts: ErrorContext, OptionalContext, JavaOptionalContext, ConfigContext, MutableContext | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.effect.EffectContextExample` | [Effect Context](https://higher-kinded-j.github.io/latest/effect/effect_context.html) |
...
| [MagnifyServiceLayerExample.java](src/main/java/org/higherkindedj/example/effect/MagnifyServiceLayerExample.java) | ReaderPath.magnify(FocusPath) for service-layer Reader-as-DI: lifts narrowly-typed sub-services into a larger AppEnv via @GenerateFocus paths | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.effect.MagnifyServiceLayerExample` | [Axes of Transformer Transformation](https://higher-kinded-j.github.io/latest/transformers/transformer_axes.html) |
...
| [ContainerNavigationExample.java](src/main/java/org/higherkindedj/example/optics/focus/ContainerNavigationExample.java) | Custom container navigation with Either, Try, Validated using some(Affine) | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.optics.focus.ContainerNavigationExample` | [Focus DSL](https://higher-kinded-j.github.io/latest/optics/focus_dsl.html) |
| [PortfolioRiskExample.java](src/main/java/org/higherkindedj/example/optics/focus/PortfolioRiskExample.java) | Cross-ecosystem portfolio risk analysis — Eclipse Collections, HKJ Either/Try/Validated, JDK Optional/Map in a single navigator chain | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.optics.focus.PortfolioRiskExample` | [Focus DSL](https://higher-kinded-j.github.io/latest/optics/focus_dsl.html) |
...
| [EditsExample.java](src/main/java/org/higherkindedj/example/optics/EditsExample.java) | Edits builder: sparse, accumulating multi-edit over optics (validated PATCH with all errors at once) | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.optics.EditsExample` | [Multi-Edit and Sparse Updates](https://higher-kinded-j.github.io/latest/optics/multi_edit.html) |
| [ValidatedPrismExample.java](src/main/java/org/higherkindedj/example/optics/ValidatedPrismExample.java) | ValidatedPrism: the parse-don't-validate optic (located reasons, total build, short-circuit nesting, sibling accumulation) | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.optics.ValidatedPrismExample` | [Validated Prisms](https://higher-kinded-j.github.io/latest/optics/validated_prism.html) |
| [GenerateMappingExample.java](src/main/java/org/higherkindedj/example/optics/GenerateMappingExample.java) | @GenerateMapping Step-0: bidirectional record mapping with total build, located accumulating parse, renames and asIso | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.optics.GenerateMappingExample` | [Release History](https://higher-kinded-j.github.io/latest/release-history.html) |
| [GenerateMergeExample.java](src/main/java/org/higherkindedj/example/optics/GenerateMergeExample.java) | @GenerateMerge: one target assembled from N sources via a typed spec method - identity fills, fallible leaves, nested fills through sibling mapping specs | `./gradlew :hkj-examples:run -PmainClass=org.higherkindedj.example.optics.GenerateMergeExample` | [Release History](https://higher-kinded-j.github.io/latest/release-history.html) |
