...
### Phase 1: Core Types
- [ ] Create `org.higherkindedj.hkt.path` package
- [ ] Create `org.higherkindedj.hkt.path.capability` package
- [ ] Implement `Composable.java`
- [ ] Implement `Chainable.java`
- [ ] Implement `Recoverable.java`
- [ ] Implement `Path.java` factory
- [ ] Implement `MaybePath.java`
- [ ] Implement `EitherPath.java`
- [ ] Implement `TryPath.java`
- [ ] Implement `ThrowingSupplier.java`
- [ ] Add `asPath()` to existing types

### Phase 2: Extensions
- [ ] Implement `IOPath.java`
- [ ] Implement `ValidatedPath.java`
- [ ] Implement `GenericPath.java`
- [ ] Implement `Accumulating.java`
- [ ] Implement `Effectful.java`
