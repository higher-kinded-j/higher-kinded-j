...
- [ ] All null-safety annotations in place

### Test Coverage

- [ ] 100% line coverage on capability interfaces
- [ ] 100% line coverage on path types
- [ ] All Functor laws verified for each path type
- [ ] All Monad laws verified for each path type
- [ ] Property-based tests for key invariants
- [ ] Integration tests for all type conversions

### Documentation

- [ ] Book chapter complete and reviewed
