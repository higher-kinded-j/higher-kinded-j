...
| Deliverable | Files | Location |
|---|---|---|
| `ForPath.from(FreePath)` entry point | Edit to `ForPath.java` | `hkj-core/.../expression/` |
| `FreePathSteps1`-`FreePathSteps12` | Generated | `hkj-core/.../expression/` |
| `par()` on FreePathSteps | Within generated steps | `hkj-core/.../expression/` |
| `let()`, `focus()` on FreePathSteps | Within generated steps | `hkj-core/.../expression/` |
| Update `@GenerateForComprehensions` | Edit processor | `hkj-processor/` |
| Tests for ForPath + FreePath | Test files | `hkj-core/src/test/` |
