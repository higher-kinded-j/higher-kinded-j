...
public class GenericExample {
  ...
  public void basicUsageExample() {
    ...
    String ioResult =
        IOKindHelper.unsafeRunSync(ioKind); // unsafeRunSync is specific to IOKindHelper
  ...
  public void genricExample() {
    ...
    System.out.println(
        "Doubled List: " + ListKindHelper.unwrap(doubledListKind)); // Output: [2, 4, 6]
    ...
    System.out.println(
        "Doubled Optional: " + OptionalKindHelper.unwrap(doubledOptKind)); // Output: Optional[20]
    ...
    System.out.println(
        "Doubled Empty Optional: "
            + OptionalKindHelper.unwrap(doubledEmptyOptKind)); // Output: Optional.empty
  }
}
