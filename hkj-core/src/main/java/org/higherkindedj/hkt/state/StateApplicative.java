...
public class StateApplicative<S> extends StateFunctor<S>
    ...
    /**
     * Lifts a value into a {@code State} context, represented as {@code Kind<StateKind.Witness<S>, A>}.
    ...
    /**
     * Applies a function wrapped in a {@code Kind<StateKind.Witness<S>, Function<A, B>>} (representing a
     * {@code State<S, Function<A,B>>}) to a value wrapped in a {@code Kind<StateKind.Witness<S>, A>}
    ...
    public <A, B> Kind<StateKind.Witness<S>, B> ap(
            Kind<StateKind.Witness<S>, ? extends Function<A, B>> ff,
            Kind<StateKind.Witness<S>, A> fa) {
