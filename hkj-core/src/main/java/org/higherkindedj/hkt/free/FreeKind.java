 ...
 */
public interface FreeKind<F extends WitnessArity<TypeArity.Unary>, A>
    extends Kind<FreeKind.Witness<F>, A> {
   ...
   */
  final class Witness<F extends WitnessArity<TypeArity.Unary>>
