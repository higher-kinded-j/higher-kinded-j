 ...
 * IO, VTask, Id, NonDet, Generic) support up to 8 chained bindings. Step 1 is hand-written as inner
 * classes; steps 2-8 are generated by the {@code hkj-processor} annotation processor ({@code
 * minArity=2, maxArity=8}).
 *
 * <h2>Motivation</h2>
 *
