...
public enum ValidatedKindHelper implements ValidatedConverterOps {
     ...
     * fully capture that {@code Validated<E, A>} is inherently a {@code Kind<ValidatedKind.Witness<E>, A>}
     * in this HKT emulation. This cast is fundamental to the HKT pattern for {@code Validated} in this library.
     *
