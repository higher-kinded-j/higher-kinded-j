...
public enum CompletableFutureKindHelper implements CompletableFutureConverterOps {
    ...
    private static final Class<CompletableFuture> TYPE = CompletableFuture.class;
    ...
    record CompletableFutureHolder<A>(CompletableFuture<A> future)
        ...
        CompletableFutureHolder {
            KindValidator.requireForWiden(future, TYPE);
        }
    }
     ...
     * @throws org.higherkindedj.hkt.exception.KindUnwrapException if the input {@code kind} is {@code null},
     *     not an instance of {@code CompletableFutureHolder}, or if the holder internally contains a {@code null} future.
     */
    @Override
    public <A> CompletableFuture<A> narrow(@Nullable Kind<CompletableFutureKind.Witness, A> kind) {
        return KindValidator.narrow(kind, TYPE, this::extractFuture);
    }
     ...
     * @throws org.higherkindedj.hkt.exception.KindUnwrapException if the input {@code kind} is invalid (e.g., null or wrong type).
