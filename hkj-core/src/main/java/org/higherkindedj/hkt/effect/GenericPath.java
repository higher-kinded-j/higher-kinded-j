...
public final class GenericPath<F extends WitnessArity<TypeArity.Unary>, A> implements Chainable<A> {
   ...
   */
  public static <F extends WitnessArity<TypeArity.Unary>, A> GenericPath<F, A> of(Kind<F, A> value, Monad<F> monad) {
   ...
   */
  public static <F extends WitnessArity<TypeArity.Unary>, E, A> GenericPath<F, A> of(Kind<F, A> value, MonadError<F, E> monadError) {
   ...
   */
  public static <F extends WitnessArity<TypeArity.Unary>, A> GenericPath<F, A> pure(A value, Monad<F> monad) {
   ...
   */
  public static <F extends WitnessArity<TypeArity.Unary>, E, A> GenericPath<F, A> pure(A value, MonadError<F, E> monadError) {
    Objects.requireNonNull(monadError, "monad must not be null");
   ...
   */
  public static <F extends WitnessArity<TypeArity.Unary>, E, A> GenericPath<F, A> raiseError(E error, MonadError<F, E> monadError) {
   ...
   */
  public <G extends WitnessArity<TypeArity.Unary>> GenericPath<G, A> mapK(NaturalTransformation<F, G> transform, Monad<G> targetMonad) {
