...
public final class FreePath<F extends WitnessArity<TypeArity.Unary>, A> implements Chainable<A> {
   ...
   */
  public static <F extends WitnessArity<TypeArity.Unary>, A> FreePath<F, A> pure(A value, Functor<F> functor) {
   ...
   */
  public static <F extends WitnessArity<TypeArity.Unary>, A> FreePath<F, A> liftF(Kind<F, A> fa, Functor<F> functor) {
   ...
   */
  public static <F extends WitnessArity<TypeArity.Unary>, A> FreePath<F, A> of(Free<F, A> free, Functor<F> functor) {
