...
class KindValidatorTest {
    ...
    class Narrow {
        ...
        void shouldNarrowKindSuccessfully() {
            ...
            var result = Validation.kind().<EitherKind.Witness<String>, String, Either<String, String>>narrow(
                    kind, (Class<Either<String, String>>) (Class<?>) Either.class, k -> EITHER.<String, String>narrow(k));
        ...
        void shouldThrowWhenKindIsNull() {
            assertNarrowNull(
                    () -> {
                        @SuppressWarnings("unchecked")
                        var unused = Validation.kind().<EitherKind.Witness<String>, String, Either<String, String>>narrow(
                                null, (Class<Either<String, String>>) (Class<?>) Either.class, k -> EITHER.<String, String>narrow(k));
                    },
                    Either.class);
        }
    ...
    class RequireNonNullWithClass {
        ...
        void shouldThrowWhenKindIsNull() {
            assertKindNull(
                    () -> Validation.kind().requireNonNull(null, TestType.class, MAP),
                    TestType.class,
                    MAP);
        }
    }
    ...
    class KindContextTest {
        ...
        void shouldCreateNarrowContext() {
            var context = KindValidator.KindContext.narrow(Either.class);

            assertThat(context.targetType()).isEqualTo(Either.class);
        ...
        void shouldCreateWidenContext() {
            var context = KindValidator.KindContext.widen(Either.class);
        ...
        void shouldGenerateCorrectInvalidTypeMessage() {
            ...
            assertThat(context.invalidTypeMessage("Maybe"))
                    .isEqualTo("Kind instance is not a Either: Maybe");
        }
    }
}