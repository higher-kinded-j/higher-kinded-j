...
class ReaderMonadTest extends ReaderTestBase {
    ...
    class OperationTests {
        ...
        void flatMapSequencesComputations() {
            Kind<ReaderKind.Witness<TestConfig>, String> result = monad.flatMap(validFlatMapper, validKind);
        ...
        void flatMapPassesEnvironmentCorrectly() {
            java.util.function.Function<Integer, Kind<ReaderKind.Witness<TestConfig>, String>> flatMapper =
    ...
    class EdgeCasesTests {
        ...
        void mapPreservesEnvironmentThreading() {
            Kind<ReaderKind.Witness<TestConfig>, TestConfig> askReader = READER.ask();
            Kind<ReaderKind.Witness<TestConfig>, String> mappedAsk = monad.map(TestConfig::url, askReader);
        ...
        void exceptionInFunctionPropagatesThroughFlatMap() {
            ...
            java.util.function.Function<Integer, Kind<ReaderKind.Witness<TestConfig>, String>> throwingFlatMapper =
                    i -> {
                        throw testException;
                    };
    ...
    class MapNTests {
        Kind<ReaderKind.Witness<TestConfig>, Integer> r1 = READER.widen(Reader.of(TestConfig::maxConnections));
