...
abstract class ReaderTestBase
    extends TypeClassTestBase<ReaderKind.Witness<ReaderTestBase.TestConfig>, Integer, String> {
  ...
  protected static final TestConfig TEST_CONFIG =
      new TestConfig(DEFAULT_URL, DEFAULT_MAX_CONNECTIONS);
  ...
  @Override
  protected Function<Integer, Kind<ReaderKind.Witness<TestConfig>, String>>
