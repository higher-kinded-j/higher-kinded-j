...
class MaybeTTest {
    ...
    class FactoryMethodTests {
        ...
        void fromMaybe_liftsMaybe() {
            MaybeT<OptionalKind.Witness, String> mtJust =
                    MaybeT.fromMaybe(outerMonad, plainJust);
            MaybeT<OptionalKind.Witness, String> mtNothing =
                    MaybeT.fromMaybe(outerMonad, plainNothing);
        ...
        void liftF_liftsOuterKind() {
            MaybeT<OptionalKind.Witness, Integer> mt =
                    MaybeT.liftF(outerMonad, wrappedOuterValue);
        ...
        void liftF_convertsNullToJustNull() {
            ...
            Kind<OptionalKind.Witness, String> nullValueKind =
        ...
        void liftF_wrapsValuesInMaybe() {
            ...
            Kind<OptionalKind.Witness, Integer> valueKind =
    ...
    class ObjectMethodTests {
        ...
        Kind<OptionalKind.Witness, Maybe<String>> wrappedEmpty1 =
    ...
    class EdgeCaseTests {
        ...
        void edgeCase_nullValuesInMaybe() {
            ...
            MaybeT<OptionalKind.Witness, String> nothing =
                    MaybeT.nothing(outerMonad);
        ...
        void edgeCase_liftFWithNullValuedOuter() {
            ...
            MaybeT<OptionalKind.Witness, String> lifted =
                    MaybeT.liftF(outerMonad, liftedValue);
