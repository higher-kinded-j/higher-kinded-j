...
public class ValidatedAssert<E, A> {
     ...
     */
    public static <E, A> ValidatedAssert<E, A> assertThat(Validated<E, A> validated) {
     ...
     * @return a new ValidatedAssert instance
     */
    public static <E, A> ValidatedAssert<E, A> assertThat(Validated<E, A> validated, String description) {
