...
class ValidatedSelectiveTest extends ValidatedTestBase {
    ...
    private Kind<ValidatedKind.Witness<String>, Integer> effectKind;
    ...
    class OperationTests {
        ...
        class SelectOperationTests {
            ...
            void selectAccumulatesErrorsFromBoth() {
                ...
                Kind<ValidatedKind.Witness<String>, String> result = selective.select(errorChoice, errorFunc);
        ...
        class WhenSOperationTests {
            ...
            void whenSPropagatesInvalidFromCondition() {
                Kind<ValidatedKind.Witness<String>, Boolean> errorCondition =
                        invalidKind(DEFAULT_ERROR);
            ...
            void whenSAccumulatesErrors() {
                Kind<ValidatedKind.Witness<String>, Boolean> errorCondition =
                        invalidKind("error1");
                Kind<ValidatedKind.Witness<String>, Integer> errorEffect = invalidKind("error2");
    ...
    class EdgeCasesTests {
        ...
        void chainedSelectiveOperations() {
            ...
            Kind<ValidatedKind.Witness<String>, Integer> result = selective.whenS(condition, doubled);

            Validated<String, Integer> validated = VALIDATED.narrow(result);
            assertThatValidated(validated).isValid().hasValue(DEFAULT_VALID_VALUE * 2);
        }
