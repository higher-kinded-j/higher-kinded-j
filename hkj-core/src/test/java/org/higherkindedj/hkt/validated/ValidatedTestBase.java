...
abstract class ValidatedTestBase
    ...
    protected Function<String, Kind<ValidatedKind.Witness<String>, Integer>>
     ...
     */
    protected <A> Validated<String, A> narrowToValidated(Kind<ValidatedKind.Witness<String>, A> kind) {
