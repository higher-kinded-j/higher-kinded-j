...
class StateApplicativeTest
        extends TypeClassTestBase<StateKind.Witness<Integer>, Integer, String> {
    ...
    class ApplicativeOperations {
        ...
        void map2ShouldCombineTwoComputations() {
            ...
            BiFunction<Integer, Integer, String> combiner =
                    (i1, i2) -> "Result: " + i1 + ", " + i2;
    ...
    class LazyEvaluation {
        ...
        void apShouldDeferExceptions() {
            ...
            Kind<StateKind.Witness<Integer>, Function<Integer, String>> ff =
                    applicative.of(throwingFunc);
            Kind<StateKind.Witness<Integer>, String> result = applicative.ap(ff, validKind);
    ...
    class ApplicativeLaws {
        ...
        void map2ConsistentWithAp() {
            ...
            // Using ap
            Function<Integer, Function<Integer, String>> curriedCombiner = i1 -> i2 -> combiner.apply(i1, i2);
