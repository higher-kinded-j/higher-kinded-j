...
public final class CoreTypeTest {
   ...
   * @return Stage for providing test instances
   */
  public static <F extends WitnessArity<TypeArity.Unary>, L, R> EitherTCoreTestStage<F, L, R> eitherT(
   ...
   * @return Stage for providing test instances
   */
  public static <F extends WitnessArity<TypeArity.Unary>, R, A> ReaderTCoreTestStage<F, R, A> readerT(
      Class<?> contextClass, Monad<F> outerMonad) {
