 ...
 *
 * <p>This class provides convenient testing for Either's KindHelper implementation with automatic
 * helper detection.
 *
...
public final class EitherKindHelperTest<L, R>
  ...
  public EitherKindHelperTest(Either<L, R> instance) {
    super(instance, getEitherClass(), either -> EITHER.widen(either), kind -> EITHER.narrow(kind));
  }
