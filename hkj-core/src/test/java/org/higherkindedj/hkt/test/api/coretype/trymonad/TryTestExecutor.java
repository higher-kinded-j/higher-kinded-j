...
final class TryTestExecutor<T, S> {
    ...
    void testValidations() {
        ...
        builder.assertFunctionNull(
                () -> successInstance.fold(null, failureMapper), "successMapper", contextClass, Operation.FOLD);
        builder.assertFunctionNull(
                () -> successInstance.fold(successMapper, null), "failureMapper", contextClass, Operation.FOLD);
        ...
        builder.assertFunctionNull(
                () -> failureInstance.recoverWith(null), "recoveryFunction", contextClass, Operation.RECOVER_WITH);
        ...
        builder.assertFunctionNull(
                () -> successInstance.toEither(null), "failureToLeftMapper", contextClass, Operation.TO_EITHER);
