...
class FreeApPathPropertyTest {
  ...
  Arbitrary<FreeApPath<MaybeKind.Witness, Integer>> freeApPaths() {
    return Arbitraries.oneOf(
        ...
        Arbitraries.integers()
            .between(-1000, 1000)
            .map(i -> FreeApPath.pure(i, Instances.monadError(maybe()))),
        // Lifted values (Just)
        Arbitraries.integers()
            .between(-1000, 1000)
            .map(i -> FreeApPath.liftF(MAYBE.just(i), Instances.monadError(maybe()))),
        // Mapped pure values
        Arbitraries.integers()
            .between(-1000, 1000)
            .map(i -> FreeApPath.pure(i, Instances.monadError(maybe())).map(x -> x * 2)));
  }
  ...
  void applicativeIdentityLaw(@ForAll("freeApPaths") FreeApPath<MaybeKind.Witness, Integer> path) {
    ...
    FreeApPath<MaybeKind.Witness, Function<Integer, Integer>> pureId =
        FreeApPath.pure(Function.identity(), Instances.monadError(maybe()));
  ...
  void applicativeHomomorphismLaw(
    ...
    FreeApPath<MaybeKind.Witness, Function<Integer, String>> pureF =
        FreeApPath.pure(f, Instances.monadError(maybe()));
    FreeApPath<MaybeKind.Witness, Integer> pureX =
        FreeApPath.pure(value, Instances.monadError(maybe()));
    ...
    FreeApPath<MaybeKind.Witness, String> rightSide =
        FreeApPath.pure(f.apply(value), Instances.monadError(maybe()));
  ...
  void applicativeInterchangeLaw(@ForAll @IntRange(min = -100, max = 100) int y) {
    ...
    FreeApPath<MaybeKind.Witness, Function<Integer, String>> u =
        FreeApPath.pure(addPrefix, Instances.monadError(maybe()));
    FreeApPath<MaybeKind.Witness, Integer> pureY =
        FreeApPath.pure(y, Instances.monadError(maybe()));
    ...
    FreeApPath<MaybeKind.Witness, Function<Function<Integer, String>, String>> dollarY =
        FreeApPath.pure(f -> f.apply(y), Instances.monadError(maybe()));
  ...
  void zipWithCombinesTwoValues(
    ...
    FreeApPath<MaybeKind.Witness, Integer> pathA =
        FreeApPath.pure(a, Instances.monadError(maybe()));
    FreeApPath<MaybeKind.Witness, Integer> pathB =
        FreeApPath.pure(b, Instances.monadError(maybe()));
  ...
  void zipWithWithLiftedValues(
    ...
    FreeApPath<MaybeKind.Witness, Integer> pathA =
        FreeApPath.liftF(MAYBE.just(a), Instances.monadError(maybe()));
    FreeApPath<MaybeKind.Witness, Integer> pathB =
        FreeApPath.liftF(MAYBE.just(b), Instances.monadError(maybe()));
  ...
  void zipWith3CombinesThreeValues(
    ...
    FreeApPath<MaybeKind.Witness, Integer> pathB =
        FreeApPath.pure(b, Instances.monadError(maybe()));
    FreeApPath<MaybeKind.Witness, Integer> pathC =
        FreeApPath.pure(c, Instances.monadError(maybe()));
