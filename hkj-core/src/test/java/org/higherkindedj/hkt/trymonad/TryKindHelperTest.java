...
class TryKindHelperTest extends TryTestBase {
  ...
  class NarrowOperations {
    ...
    void narrow_shouldReturnOriginalSuccess() {
      ...
      assertThat(result).as("narrow should return same instance").isSameAs(successInstance);
    }
    ...
    void narrow_shouldReturnOriginalFailure() {
      ...
      assertThat(result).as("narrow should return same instance").isSameAs(failureInstance);
    }
  ...
  class EdgeCases {
    ...
    void roundTripWithFailureShouldPreserveException() {
      ...
      assertThatThrownBy(result::get).as("should throw same exception").isSameAs(testException);
    }
