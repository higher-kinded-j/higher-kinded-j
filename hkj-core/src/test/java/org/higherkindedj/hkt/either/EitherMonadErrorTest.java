...
/**
 * EitherMonad Error Handling Test Suite using enhanced testing infrastructure.
 *
 * <p>Demonstrates best practices for testing MonadError implementations using:
 *
 * <ul>
 *   <li>TypeClassTestBase for fixture management
 *   <li>FlexibleValidationConfig for inheritance-aware validation
 *   <li>Direct test methods for reliable compilation
 *   <li>TestPatternValidator for structure validation
 * </ul>
 */
...
class EitherMonadErrorTest extends TypeClassTestBase<EitherKind.Witness<String>, Integer, String> {
  ...
  @Nested
  @DisplayName("Complete Test Suite Using Builder Pattern")
  class CompleteTestSuite {

    @Test
    @DisplayName("Run complete MonadError test pattern")
    void runCompleteMonadErrorTestPattern() { // ← Renamed
      // Create validation config with inheritance-aware validation
      FlexibleValidationConfig.MonadErrorValidation<
              EitherKind.Witness<String>, String, Integer, String>
          validationConfig =
              new FlexibleValidationConfig.MonadErrorValidation<>(
                  ...
                  .flatMapWithClassContext(EitherMonad.class)
                  .handleErrorWithClassContext(EitherMonad.class);
      ...
      // Test validations using the config
