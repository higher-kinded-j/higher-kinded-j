...
class EitherTraverseTest extends TypeClassTestBase<EitherKind.Witness<String>, Integer, String> {
  ...
  class CompleteTraverseTestSuite {
    ...
    void runCompleteTraverseTestPattern() {
      TypeClassTestPattern.testCompleteTraverse(
          traverse,
          EitherTraverse.class,
          rightKind,
          validMapper,
          maybeApplicative,
  ...
  class IndividualComponents {
    ...
    void testExceptionPropagationOnly() {
      TypeClassTestPattern.testTraverseExceptionPropagation(
          traverse, rightKind, maybeApplicative, validMonoid);
    }
    ...
    void testLawsOnly() {
      TypeClassTestPattern.testTraverseLaws(
          traverse, maybeApplicative, rightKind, validTraverseFunction, maybeEqualityChecker);
    }
  }
