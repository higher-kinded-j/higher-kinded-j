...
public class EitherAssert<L, R> extends AbstractAssert<EitherAssert<L, R>, Either<L, R>> {
     ...
     */
    public EitherAssert<L, R> hasRightSatisfying(
            java.util.function.Consumer<? super R> requirements) {
        isRight();
     ...
     */
    public EitherAssert<L, R> hasLeftSatisfying(java.util.function.Consumer<? super L> requirements) {
        isLeft();
