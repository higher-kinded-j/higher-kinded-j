...
class EitherApplicativeTest extends EitherTypeClassTestBase {
    ...
    class OperationTests {
        ...
        void apPropagatesLeftFromFunction() {
            Kind<EitherKind.Witness<String>, Function<Integer, String>> funcKind =
                    leftKindTyped(TestErrorType.FUNCTION_ERROR);
            Kind<EitherKind.Witness<String>, Integer> valueKind = applicative.of(DEFAULT_RIGHT_VALUE);

            var result = applicative.ap(funcKind, valueKind);

            assertLeft(narrowToEither(result), TestErrorType.FUNCTION_ERROR);
        }
    ...
    class EdgeCasesTests {
        ...
        void mapNShortCircuitsOnFirstLeft() {
            ...
            Kind<EitherKind.Witness<String>, String> l2 = leftKindTyped(TestErrorType.ERROR_2);
            ...
            assertLeft(narrowToEither(result), TestErrorType.ERROR_1);
        }
