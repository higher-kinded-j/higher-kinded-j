...
/**
 * Either core functionality test using standardized patterns.
 *
 * <p>This test focuses on the core Either functionality while using the standardised validation
...
class EitherTest {
  ...
  class GetterMethodsTests {
    ...
    void getLeftWorksCorrectly() {
      ...
      // Complex types
      RuntimeException exception = TestExceptions.runtime("test");
  ...
  class FoldMethodTests {
    ...
    void foldHandlesExceptionPropagation() {
      RuntimeException testException = TestExceptions.runtime("fold test");
  ...
  class FlatMapMethodTests {
    ...
    void flatMapHandlesExceptionPropagation() {
      RuntimeException testException = TestExceptions.runtime("flatMap test");
  ...
  class PerformanceAndMemoryTests {
    ...
    void memoryUsageIsReasonableForLargeChains() {
      // Test that long chains don't create excessive garbage
