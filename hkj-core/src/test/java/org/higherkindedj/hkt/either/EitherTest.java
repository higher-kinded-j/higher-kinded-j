...
class EitherTest extends EitherTypeClassTestBase {
    ...
    class FactoryMethods {
        ...
        void leftCreatesCorrectInstances() {
            ...
            assertThatEither(leftInstance).isLeft().hasLeft(leftValue);
            ...
            assertThatEither(exceptionLeft).isLeft().hasLeft(exception);

            // Empty string
            Either<String, Integer> emptyLeft = Either.left("");
            assertThatEither(emptyLeft).isLeft().hasLeft("");
        }
        ...
        void rightCreatesCorrectInstances() {
            ...
            assertThatEither(rightInstance).isRight().hasRight(rightValue);
            ...
            assertThatEither(listRight).isRight().hasRight(list);

            // Primitives and wrappers
            Either<String, Boolean> boolRight = Either.right(true);
            assertThatEither(boolRight).isRight().hasRight(true);
        }
        ...
        void factoryMethodsTypeInference() {
            ...
            assertThatEither(leftAssignment).isLeft().hasLeft("error");
            assertThatEither(rightAssignment).isRight().hasRight(42);
        }
    }
    ...
    class MapMethodTests {
        ...
        void mapAppliesFunctionToRight() {
            ...
            assertThatEither(result).isRight().hasRight("123");

            // Complex transformation
            Either<String, List<Integer>> listResult = rightInstance.map(i -> List.of(i, i * 2));
            assertThatEither(listResult).isRight().hasRightSatisfying(list -> {
            ...
            assertThatEither(nullResult).isRight().hasRight("null");
        }
        ...
        void mapPreservesLeftInstances() {
            ...
            assertThatEither(result).isLeft().hasLeft(leftValue);
        ...
        void mapHandlesExceptionPropagation() {
            ...
            assertThatEither(chainResult).isRight().hasRight("VALUE: 20");
            ...
            assertThatEither(leftChainResult).isLeft().hasLeft("error");
        }
    ...
    class FlatMapMethodTests {
        ...
        void flatMapSupportsComplexChaining() {
            ...
            assertThatEither(result).isRight().hasRight("VALUE: 20");
            ...
            assertThatEither(failureResult).isLeft().hasLeft("Error occurred");
            ...
            Either<String, Integer> mixedResult =
                    start
                            ...
                            .map(i -> i - 10); // 20
            assertThatEither(mixedResult).isRight().hasRight(20);
        }
    ...
    class AdvancedUsagePatterns {
        ...
        void eitherAsFunctorMaintainsStructure() {
            ...
            assertThatEither(result).isRight().hasRightSatisfying(value -> {
        ...
        void eitherForRailwayOrientedProgramming() {
            ...
            assertThatEither(success).isRight().hasRight("4.00");
            ...
            Either<String, String> parseFailure =
                    Either.<String, String>right("not-a-number")
                            ...
                            .flatMap(squareRoot)
                            .flatMap(formatResult);
            assertThatEither(parseFailure).isLeft().hasLeftSatisfying(error -> {
            ...
            Either<String, String> negativeFailure =
                    Either.<String, String>right("-4")
                            ...
                            .flatMap(squareRoot)
                            .flatMap(formatResult);
            assertThatEither(negativeFailure).isLeft().hasLeftSatisfying(error -> {
        ...
        void eitherWithResourceManagement() {
            ...
            assertThatEither(result).isRight().hasRight("Processed: test");
            ...
            assertThatEither(failureResult).isLeft().hasLeft("Processing failed");
        }
    ...
    class PerformanceAndMemoryTests {
        ...
        void memoryUsageIsReasonableForLargeChains() {
            ...
            assertThatEither(result).isRight().hasRight(1 + (999 * 1000) / 2);
    ...
    class TypeSafetyAndVarianceTests {
        ...
        void eitherMaintainsTypeSafety() {
            ...
            assertThatEither(intEither).isRight().hasRight(42);
            ...
            assertThatEither(processedEither).isLeft().hasLeftSatisfying(ex -> {
            ...
            assertThatEither(processedRuntime).isLeft().hasLeftSatisfying(ex -> {
                assertThat(ex).isInstanceOf(RuntimeException.class);
            });
        }
        ...
        void eitherWorksWithComplexGenericTypes() {
            ...
            assertThatEither(summed).isRight().hasRight(6);
            ...
            assertThatEither(keySet).isRight().hasRightSatisfying(keys -> {
    ...
    class EdgeCasesAndBoundaryConditions {
        ...
        void eitherHandlesExtremeValuesCorrectly() {
            ...
            assertThatEither(largeRight.map(String::length)).isRight().hasRight(10000);
            ...
            assertThatEither(promoted).isRight().hasRight((long) Integer.MAX_VALUE + 1);
            ...
            assertThatEither(flattened).isRight().hasRight(42);
        }
        ...
        void eitherOperationsAreStackSafe() {
            ...
            assertThatEither(result).isRight().hasRight(10000);
            ...
            assertThatEither(flatMapResult).isRight().hasRight(1000);
        }
        ...
        void eitherHandlesConcurrentModificationsSafely() {
            ...
            assertThatEither(sizeEither).isRight().hasRight(3);
            ...
            assertThatEither(newSizeEither).isRight().hasRight(4);
        }
