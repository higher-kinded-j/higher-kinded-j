...
/**
 * Return value handler that automatically converts {@link Either} return values
 * from controller methods into appropriate HTTP responses.
 * <p>
 * Conversion rules:
 * <ul>
 *   <li>{@code Right<A>} → HTTP 200 OK with value as JSON body</li>
 *   <li>{@code Left<E>} → HTTP 4xx/5xx with error as JSON body</li>
 * </ul>
 * </p>
 * <p>
 * Error status codes are determined by examining the error class name:
 * <ul>
 *   <li>Contains "notfound" → 404 Not Found</li>
 *   <li>Contains "validation" or "invalid" → 400 Bad Request</li>
 *   <li>Contains "authorization" or "forbidden" → 403 Forbidden</li>
 *   <li>Contains "authentication" or "unauthorized" → 401 Unauthorized</li>
 *   <li>Default → 400 Bad Request</li>
 * </ul>
 * </p>
 */
public class EitherReturnValueHandler implements HandlerMethodReturnValueHandler {
     ...
     * Uses simple heuristics based on the error class name.
     *
