...
Higher-Kinded-J needs **Java 25 or later with preview features enabled**: a build without
`--enable-preview` will not compile. The [Quickstart](quickstart.md) has the one build line that
