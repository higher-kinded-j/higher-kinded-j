...
| [A sealed request body got a 500, with no field path](structure.md#sealed-hierarchies) | Jackson cannot pick a subtype without type information, and Spring does not map that to a client error: annotate the wire interface with `@JsonTypeInfo`. |
