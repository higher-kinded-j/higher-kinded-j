...
**Definition:** An immutable, fixed-size container that groups multiple values of potentially different types into a single value. Higher-Kinded-J provides `Tuple2` through `Tuple8`, where the number indicates how many elements the tuple holds.
...
- `Tuple6` through `Tuple8` are generated by the `hkj-processor` annotation processor
...
**Related:** [For Comprehension](functional/for_comprehension.md), [Bifunctor](#bifunctor) (for `Tuple2`)
...
**Related:** [Scope](#scope), [Validated](#validated), [ScopeJoiner Documentation](monads/vtask_scope.md)
