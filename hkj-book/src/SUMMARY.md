...
- [Effect Path API](effect/ch_intro.md)
  ...
  - [Core Paths](effect/effect_path_overview.md)
    ...
    - [Path Types Overview](effect/path_types.md)
  ...
  - [Optics Integration](effect/focus_integration.md)
    - [Capstone: Effects Meet Optics](effect/capstone_focus_effect.md)
  - [Advanced Paths](effect/advanced_topics.md)
    ...
    - [ForPath Parallel Composition](effect/forpath_par.md)
    - [ForPath Traverse](effect/forpath_traverse.md)
  ...
  - [Reference](effect/capabilities.md)
...
- [Optics](optics/ch_intro.md)
  ...
  - [Annotations at a Glance](optics/annotations_at_a_glance.md)
  - [Fundamentals](optics/ch1_intro.md)
  ...
  - [Collections](optics/ch2_intro.md)
  ...
  - [Precision and Filtering](optics/ch3_intro.md)
  ...
  - [Reference](optics/ch7_intro.md)
    ...
    - [Production Readiness](optics/production_readiness.md)
...
- [Mapping at the Boundary](mapping/ch_intro.md)
  ...
  - [The Emission Tiers](mapping/tiers.md)
  - [Beans and Sparse PATCH](mapping/beans_patch.md)
...
- [Foundations](hkts/foundations_intro.md)
  ...
  - [Type Classes](functional/ch_intro.md)
    ...
    - [For Comprehension](functional/for_comprehension.md)
      - [Parallel Composition](functional/for_par.md)
      - [Traverse Within Comprehensions](functional/for_traverse.md)
      - [Optics Integration](functional/for_optics.md)
      - [MTL & ForState Bridge](functional/for_mtl.md)
    - [ForState Comprehension](functional/forstate_comprehension.md)
    - [Choosing Abstraction Levels](functional/abstraction_levels.md)
  - [Core Types](monads/ch_intro.md)
    - [Supported Types](monads/supported-types.md)
    - [CompletableFuture](monads/cf_monad.md)
    - [Either](monads/either_monad.md)
    - [EitherOrBoth](monads/either_or_both_monad.md)
...
- [Hands-On Learning](tutorials/ch_intro.md)
  ...
  - [Core Types](tutorials/coretypes/ch_intro.md)
    - [Foundations](tutorials/coretypes/foundations_journey.md)
      - [Cheatsheet](tutorials/coretypes/foundations_cheatsheet.md)
  ...
  - [Effect API](tutorials/effect/effect_journey.md)
    - [Cheatsheet](tutorials/effect/effect_cheatsheet.md)
  ...
  - [Context](tutorials/context/ch_intro.md)
  - [Effect Handlers](tutorials/effecthandlers/ch_intro.md)
  - [Optics](tutorials/optics/ch_intro.md)
    - [Lens & Prism](tutorials/optics/lens_prism_journey.md)
  ...
  - [Expression](tutorials/expression/ch_intro.md)
    ...
    - [ForPath Parallel](tutorials/expression/forpath_parallel_journey.md)
  - [Resilience Patterns](tutorials/resilience/resilience_journey.md)
  - [Capstone: One Line, Six Layers Grows Up](tutorials/capstone/capstone_journey.md)
...
- [Project Info](project_info_intro.md)
