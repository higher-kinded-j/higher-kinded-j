...
Three journeys that build from the `Kind<F, A>` encoding up through typed error handling to advanced patterns. Work them in order for a gradual ramp, or jump to whichever matches your immediate need.
...
**Next:** [Foundations](foundations_journey.md)
