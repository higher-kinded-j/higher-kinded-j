...
Want to learn by doing? Try our **[Core Types Tutorial Track](../tutorials/coretypes/ch_intro.md)** with 7 interactive exercises that take you from `Kind<F, A>` basics to production workflows in ~60 minutes.
~~~
