...
| **Boundary Mapping** | [GenerateMappingExample](https://github.com/higher-kinded-j/higher-kinded-j/blob/main/hkj-examples/src/main/java/org/higherkindedj/example/optics/GenerateMappingExample.java), [BoundaryCapstoneBook](https://github.com/higher-kinded-j/higher-kinded-j/blob/main/hkj-examples/src/main/java/org/higherkindedj/example/book/mapping/capstone/BoundaryCapstoneBook.java) | Generated domain ↔ DTO mapping, every bad field located (see [Mapping at the Boundary](../mapping/ch_intro.md)) |
