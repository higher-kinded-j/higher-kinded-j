...
- **[Core Types Tutorials](tutorials/coretypes_track.md)** (~60 minutes): Master Functors, Applicatives, and Monads through 7 progressive exercises that build from `Kind<F, A>` basics to production workflows
- **[Optics Tutorials](tutorials/optics_track.md)** (~90 minutes): Learn Lenses, Prisms, and Traversals with 9 real-world scenarios from simple field updates to complex Free Monad DSLs
