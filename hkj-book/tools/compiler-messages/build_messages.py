...
Run from the repository root, after writing the two classpaths it compiles with:
...
//
// Generated by hkj-book/tools/compiler-messages/build_messages.py: edit messages.py there and
...
<!-- Generated by hkj-book/tools/compiler-messages/build_messages.py from messages.py.
     Edit messages.py and rerun the script, rather than editing this page; see README.md there. -->
