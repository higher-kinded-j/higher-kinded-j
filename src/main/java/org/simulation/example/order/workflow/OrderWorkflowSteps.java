 ...
 * simulation framework with {@link Either} for error handling and {@link CompletableFuture} for
 * asynchronous operations. Logging is now performed via the injected {@link Dependencies}.
 *
