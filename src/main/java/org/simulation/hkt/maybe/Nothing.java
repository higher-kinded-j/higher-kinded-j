...
final class Nothing<T> implements Maybe<T> {
  ...
  @Override public @NonNull T get() { throw new NoSuchElementException("Cannot call get() on Nothing"); }

  @Override public @NonNull T orElse(@NonNull T other) { return other; }

  @Override public @NonNull T orElseGet(@NonNull Supplier<? extends @NonNull T> other) {
