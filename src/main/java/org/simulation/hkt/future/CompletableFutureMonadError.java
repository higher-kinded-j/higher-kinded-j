...
public class CompletableFutureMonadError extends CompletableFutureMonad implements MonadError<CompletableFutureKind<?>, Throwable> {
    ...
    @Override
    public <A> @NonNull Kind<CompletableFutureKind<?>, A> handleErrorWith(@NonNull Kind<CompletableFutureKind<?>, A> ma, @NonNull Function<Throwable, Kind<CompletableFutureKind<?>, A>> handler) {
        ...
        CompletableFuture<A> recoveredFuture = futureA.exceptionallyCompose(throwable -> {
            ...
            Throwable cause = (throwable instanceof CompletionException && throwable.getCause() != null)
                ? throwable.getCause() : throwable; // cause is NonNull
