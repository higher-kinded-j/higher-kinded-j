...
public class CompletableFutureFunctor implements Functor<CompletableFutureKind<?>> {
    ...
    @Override
    public <A, B> @NonNull Kind<CompletableFutureKind<?>, B> map(@NonNull Function<A, @Nullable B> f, @NonNull Kind<CompletableFutureKind<?>, A> fa) { // Allow function result to be null
