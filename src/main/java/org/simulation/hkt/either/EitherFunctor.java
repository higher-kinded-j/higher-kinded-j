...
public class EitherFunctor<L> implements Functor<EitherKind<L, ?>> {
   ...
   * @return A new EitherKind with the function applied to the Right value, or the original Left propagated. (NonNull)
   */
  @Override
  public <A, B> @NonNull Kind<EitherKind<L, ?>, B> map(@NonNull Function<A, B> f, @NonNull Kind<EitherKind<L, ?>, A> ma) {
