...
/**
 * Kind interface marker for the Either<L, R> type in the HKT simulation. Represents Either<L, -> as
 * a type constructor 'F' in Kind<F, A>, where 'L' is fixed and 'A' corresponds to the 'R' (Right)
 * type parameter. This structure facilitates defining Functor/Monad instances biased towards the
 * Right value.
 *
