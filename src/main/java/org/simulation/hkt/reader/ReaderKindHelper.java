...
public final class ReaderKindHelper {
  ...
  public static final String INVALID_HOLDER_STATE_MSG = "ReaderHolder contained null Reader instance";
  ...
  /**
   * Unwraps a ReaderKind back to the concrete Reader<R, A> type.
   * Throws KindUnwrapException if the Kind is null, not a ReaderHolder,
   * or the holder contains a null Reader instance.
   */
  ...
  /**
   * Wraps a concrete Reader<R, A> value into the ReaderKind simulation type.
   * Requires a non-null Reader as input.
   */
   ...
   */
  public static <R, A> @Nullable A runReader(@NonNull Kind<ReaderKind<R, ?>, A> kind, @NonNull R environment) {
