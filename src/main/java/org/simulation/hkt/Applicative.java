...
public interface Applicative<F> extends Functor<F> {
   ...
   * @return The value wrapped in the context F (e.g., ListKind<A>, OptionalKind<A>). Guaranteed non-null.
   */
   ...
   * @return A new context F containing the result of applying the function (if both function and value are available). Guaranteed non-null.
   */
  ...
  default <A, B, C> @NonNull Kind<F, C> map2(@NonNull Kind<F, A> fa, @NonNull Kind<F, B> fb, @NonNull Function<A, Function<B, C>> f) {
   ...
   */
  default <A, B, C> @NonNull Kind<F, C> map2(@NonNull Kind<F, A> fa, @NonNull Kind<F, B> fb, @NonNull BiFunction<A, B, C> f) {
   ...
   * @return Applicative context containing the result of applying f. Guaranteed non-null.
   */
  default <A, B, C, R> @NonNull Kind<F, R> map3(@NonNull Kind<F, A> fa, @NonNull Kind<F, B> fb, @NonNull Kind<F, C> fc, @NonNull Function3<A, B, C, R> f) {
  ...
  default <A, B, C, D, R> @NonNull Kind<F, R> map4(@NonNull Kind<F, A> fa, @NonNull Kind<F, B> fb, @NonNull Kind<F, C> fc, @NonNull Kind<F, D> fd, @NonNull Function4<A, B, C, D, R> f) {
