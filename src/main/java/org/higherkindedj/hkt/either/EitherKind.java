...
/**
 * Kind interface marker for the {@code Either<L, R>} type in the Higher-Kinded-J. Represents {@code Either<L, ?>}
 * as a type constructor 'F' in {@code Kind<F, A>}, where 'L' is fixed and 'A' corresponds to the 'R'
