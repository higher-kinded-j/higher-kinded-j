...
/**
 * Kind interface marker for the {@code MaybeT<F, A>} monad transformer. Represents {@code MaybeT<F, ?>} as a type
 * constructor 'G' in {@code Kind<G, A>}. The wrapped value is of type {@code Kind<F, Maybe<A>>}.
 *
