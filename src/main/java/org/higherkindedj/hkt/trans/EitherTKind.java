...
/**
 * Kind interface marker for the {@code EitherT<F, L, R>} monad transformer. Represents {@code
 * EitherT<F, L, ?>} -> as a type constructor 'G' in {@code Kind<G, A>}, where 'F' and 'L' are
 * fixed, and 'A' corresponds to the 'R' (Right) type parameter. The wrapped value is of type {@code
 * Kind<F, Either<L, R>>}.
 *
