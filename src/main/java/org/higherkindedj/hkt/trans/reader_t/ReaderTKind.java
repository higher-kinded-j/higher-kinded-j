...
/**
 * Kind interface marker for the {@code ReaderT<F, R, A>} monad transformer. Represents {@code
 * ReaderT<F, R, ?>} as a type constructor 'G' in {@code Kind<G, A>}. The underlying structure
 * conceptually represents {@code R -> F<A>}.
 *
