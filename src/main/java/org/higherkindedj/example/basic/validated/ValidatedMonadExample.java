...
public class ValidatedMonadExample {
  ...
  private static void validatedMonadOperations() {
    ...
    System.out.println("From monad.of(42): " + ValidatedKindHelper.narrow(validKindFromOf));

    // Using Validated.valid() and ValidatedKindHelper.widen()
    Validated<List<String>, String> rawValid = Validated.valid("Success!");
    Kind<ValidatedKind.Witness<List<String>>, String> validKind =
        ValidatedKindHelper.widen(rawValid);
    System.out.println(
        "From Validated.valid() & widen(): " + ValidatedKindHelper.narrow(validKind));

    // Using Validated.invalid() and ValidatedKindHelper.widen()
    ...
    Kind<ValidatedKind.Witness<List<String>>, String> invalidKindFromHelper = // Renamed for clarity
        ValidatedKindHelper.widen(rawInvalid);
    System.out.println(
        "From Validated.invalid() & widen(): " + ValidatedKindHelper.narrow(invalidKindFromHelper));

    // Using ValidatedKindHelper.valid() for
    Kind<ValidatedKind.Witness<List<String>>, String> vKind = ValidatedKindHelper.valid("Success!");
    System.out.println("From ValidatedHelper.valid(): " + ValidatedKindHelper.narrow(vKind));

    // ValidatedKindHelper.invalid()
    Kind<ValidatedKind.Witness<List<String>>, String> idKind =
        ValidatedKindHelper.invalid(Collections.singletonList("Error: Something went wrong."));
    System.out.println("From ValidatedHelper.invalid(): " + ValidatedKindHelper.narrow(idKind));
    ...
    Kind<ValidatedKind.Witness<List<String>>, Integer>
        ...
        ValidatedKindHelper.widen(rawInvalidInt);
    ...
    Function<Integer, Kind<ValidatedKind.Witness<List<String>>, String>> intToValidatedStringKind =
        i -> {
          if (i > 0) {
            return ValidatedKindHelper.widen(Validated.valid("Positive: " + i));
          } else {
            // For flatMap, the function itself returns a Kind
            return ValidatedKindHelper.invalid(
                Collections.singletonList("Number not positive: " + i));
          }
        };
    ...
    System.out.println(
        "FlatMap (Valid to Valid): " + ValidatedKindHelper.narrow(flatMappedToValid));
    ...
    System.out.println(
        "FlatMap (Valid to Invalid): " + ValidatedKindHelper.narrow(flatMappedToInvalid));
    ...
    System.out.println(
        "FlatMap (Invalid input): " + ValidatedKindHelper.narrow(flatMappedFromInvalid));
    ...
    Kind<ValidatedKind.Witness<List<String>>, Function<Integer, String>> validFnKind =
        ValidatedKindHelper.widen(Validated.valid(i -> "Applied: " + (i * 2)));
    Kind<ValidatedKind.Witness<List<String>>, Function<Integer, String>> invalidFnKind =
        ValidatedKindHelper.widen(
    ...
    System.out.println(
        "Ap (InvalidFn, ValidVal): " + ValidatedKindHelper.narrow(apInvalidFnValidVal));
    ...
    System.out.println(
        "Ap (ValidFn, InvalidVal): " + ValidatedKindHelper.narrow(apValidFnInvalidVal));
    ...
    System.out.println(
        "Ap (InvalidFn, InvalidVal): " + ValidatedKindHelper.narrow(apInvalidFnInvalidVal));

    // --- 5. Folding Validated (using Validated.fold()) ---
    System.out.println("\n--- 5. Folding Validated ---");
    Validated<List<String>, String> unwrappedValidFold =
        ValidatedKindHelper.narrow(mappedValid); // Renamed
    String foldResult1 =
    ...
    Validated<List<String>, String> unwrappedInvalidFold =
        ValidatedKindHelper.narrow(mappedInvalid);
    String foldResult2 =
    ...
    Function<List<String>, Kind<ValidatedKind.Witness<List<String>>, String>>
        recoveryHandlerToValid =
            errors -> {
              ...
              return ValidatedKindHelper.valid("Recovered from " + errors.toString());
            };
    ...
    System.out.println(
        "handleErrorWith (Invalid -> Valid): " + ValidatedKindHelper.narrow(recoveredToValid));
    ...
    Function<List<String>, Kind<ValidatedKind.Witness<List<String>>, String>>
        recoveryHandlerToInvalid =
            errors -> {
              ...
              return ValidatedKindHelper.invalid(newErrorPayload);
            };
    ...
    System.out.println(
        "handleErrorWith (Invalid -> Invalid): " + ValidatedKindHelper.narrow(recoveredToInvalid));
    ...
    System.out.println(
        "handleErrorWith (Valid input): "
            + ValidatedKindHelper.narrow(notRecovered)
    ...
    System.out.println(
        "handleError (Invalid -> plain value -> Valid): "
            + ValidatedKindHelper.narrow(recoveredWithHandleError));
    ...
    System.out.println("Parsed Input 1 (Combined): " + ValidatedKindHelper.narrow(parsed1));
    System.out.println("Parsed Input 2 (Combined): " + ValidatedKindHelper.narrow(parsed2));
    ...
    System.out.println(
        "Parsed Input 2 (Recovered to 0): " + ValidatedKindHelper.narrow(parsed2Recovered));

    Validated<List<String>, Integer> finalResult1 = ValidatedKindHelper.narrow(parsed1);
    ...
    Validated<List<String>, Integer> finalResult2Recovered =
        ValidatedKindHelper.narrow(parsed2Recovered);
