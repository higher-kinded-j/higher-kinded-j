    ...
    void ofShouldCreateNonParameterisedInfo() {
      var info =
          KindFieldInfo.of(
              ...
              com.palantir.javapoet.TypeName.get(String.class),
              "ListTraverse.INSTANCE",
              org.higherkindedj.optics.annotations.KindSemantics.ZERO_OR_MORE);
      ...
      assertThat(info.semantics())
          .isEqualTo(org.higherkindedj.optics.annotations.KindSemantics.ZERO_OR_MORE);
    }
    ...
    void parameterisedShouldCreateParameterisedInfo() {
      var info =
          KindFieldInfo.parameterised(
              ...
              com.palantir.javapoet.TypeName.get(Integer.class),
              "EitherTraverse.<String>instance()",
              org.higherkindedj.optics.annotations.KindSemantics.ZERO_OR_ONE,
              "String");
      ...
      assertThat(info.semantics())
          .isEqualTo(org.higherkindedj.optics.annotations.KindSemantics.ZERO_OR_ONE);
    }
  }
