...
class MutationKillingPhase3Test {
  ...
  class NavigatorCreateNavigatorMethodTests {
    ...
    void nonNavigableFieldShouldUseStandardMethod() throws IOException {
      ...
      Compilation compilation =
          javac().withProcessors(new FocusProcessor()).compile(source);
  ...
  class NavigatorConstructorArgsLambdaTests {
    ...
    @Test
    @DisplayName("Navigator method should use newValue for matching component and source for others")
  ...
  class FocusProcessorGenerateFocusFileTests {
    ...
    void focusWithExplicitTargetPackageShouldWork() throws IOException {
      ...
      assertThat(compilation)
          .generatedSourceFile("com.example.generated.GadgetFocus")
          .isNotNull();
    }
  }
  ...
  class TraversalProcessorCreateTraversalMethodTests {
    ...
    void listFieldShouldGenerateTraversalWithCorrectFocusType() throws IOException {
      ...
      // Should generate a traversal for the List<String> field
      assertThat(code).contains("booksTraversal");
      assertThat(code).contains("Traversal<Shelf, String>");
      // Should NOT generate traversal for plain String field
      assertThat(code).doesNotContain("locationTraversal");
    }
    ...
    void setFieldShouldGenerateTraversal() throws IOException {
      ...
      assertThat(code).contains("memberIdsTraversal");
    }
  ...
  class ForComprehensionProcessorBoundaryTests {
    ...
    void maxArity26ShouldSucceed() {
      ...
      // maxArity = 26 is valid, should not produce errors about maxArity
  ...
  class KindRegistryMappingFactoryTests {
    ...
    @Test
    @DisplayName("Lookup for instance-based kind (ListKind) should return non-null non-parameterised mapping")
    ...
    @Test
    @DisplayName("Lookup for factory-based kind (EitherKind) should return non-null parameterised mapping")
    ...
    void extractWitnessTypeArgsNestedGenericsReturnsFullInner() {
      String result = KindRegistry.extractWitnessTypeArgs("org.example.Witness<Map<String, Integer>>");
  ...
  class ForPathStepGeneratorTests {
    ...
    void eitherPathStepsShouldHaveCorrectTypeParams() {
      ...
      Optional<JavaFileObject> eitherSteps =
          compilation.generatedSourceFile("com.example.EitherPathSteps2");
    ...
    void genericPathStepsShouldHaveCorrectTypeParams() {
      ...
      Optional<JavaFileObject> genericSteps =
          compilation.generatedSourceFile("com.example.GenericPathSteps2");
    ...
    void maybePathStepsShouldBeFilterable() throws IOException {
      ...
      Optional<JavaFileObject> maybeSteps =
          compilation.generatedSourceFile("com.example.MaybePathSteps2");
    ...
    void forPathStepsShouldGenerateAllPathTypes() {
      ...
      assertThat(compilation.generatedSourceFile("com.example.MaybePathSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.OptionalPathSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.EitherPathSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.TryPathSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.IOPathSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.VTaskPathSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.IdPathSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.NonDetPathSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.GenericPathSteps2")).isPresent();
    }
  }
  ...
  class ForStepGeneratorFilterableTests {
    ...
    void shouldGenerateBothMonadicAndFilterableSteps() {
      ...
      assertThat(compilation.generatedSourceFile("com.example.MonadicSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.MonadicSteps3")).isPresent();

      // FilterableSteps should also exist
      assertThat(compilation.generatedSourceFile("com.example.FilterableSteps2")).isPresent();
      assertThat(compilation.generatedSourceFile("com.example.FilterableSteps3")).isPresent();
    }
    ...
    void filterableStepsShouldContainWhenMethod() throws IOException {
      ...
      String code =
          compilation
              .generatedSourceFile("com.example.FilterableSteps2")
              .get()
              .getCharContent(true)
              .toString();
  ...
  class TupleGeneratorMapAllTests {
    ...
    void generatedTupleShouldContainMapAllMethod() throws IOException {
      ...
      String code =
          compilation
              .generatedSourceFile("com.example.Tuple4")
              .get()
              .getCharContent(true)
              .toString();

      // mapAll should exist with correct number of mapper parameters
    ...
    void tuple2ShouldHaveBimapInsteadOfMap() throws IOException {
      ...
      String code =
          compilation
              .generatedSourceFile("com.example.Tuple2")
              .get()
              .getCharContent(true)
              .toString();
    ...
    void tupleMapAllShouldValidateEachMapper() throws IOException {
      ...
      String code =
          compilation
              .generatedSourceFile("com.example.Tuple3")
              .get()
              .getCharContent(true)
              .toString();
  ...
  class ImportOpticsProcessorSpecInterfaceTests {
    ...
    void interfaceExtendingOpticsSpecShouldBeProcessedAsSpec() {
      ...
      var spec =
          JavaFileObjects.forSourceString(
              ...
              public interface EmployeeOptics extends OpticsSpec<Employee> {
                  Lens<Employee, String> name();
                  Lens<Employee, Integer> salary();
              }
              """);
      ...
      // Should generate an implementation class
      assertThat(compilation)
          .generatedSourceFile("com.example.EmployeeOpticsImpl")
          .isNotNull();
    }
    ...
    void interfaceNotExtendingOpticsSpecShouldBeProcessedAsType() {
      ...
      assertThat(compilation)
          .generatedSourceFile("com.example.ProductLenses")
          .isNotNull();
    }
    ...
    void classWithImportOpticsShouldBeProcessedAsType() {
      ...
      assertThat(compilation)
          .generatedSourceFile("com.example.VehicleLenses")
          .isNotNull();
    }
  }
  ...
  class ProcessorUtilsToCamelCaseTests {
    ...
    void toCamelCaseShouldConvertUnderscoreCase() {
      String result =
          org.higherkindedj.optics.processing.util.ProcessorUtils.toCamelCase("hello_world");
    ...
    void toCamelCaseShouldHandleSingleWord() {
      String result =
          org.higherkindedj.optics.processing.util.ProcessorUtils.toCamelCase("hello");
    ...
    void toCamelCaseShouldHandleEmptyString() {
      String result =
          org.higherkindedj.optics.processing.util.ProcessorUtils.toCamelCase("");
      assertThat(result).isEmpty();
    }
    ...
    void toCamelCaseShouldHandleMultipleUnderscores() {
      String result =
          org.higherkindedj.optics.processing.util.ProcessorUtils.toCamelCase("my_long_name_here");
    ...
    void collectionSubtypeShouldBeDetectedAsTraversal() throws IOException {
      ...
      var outer =
          JavaFileObjects.forSourceString(
              ...
              @GenerateFocus(generateNavigators = true)
              public record Store(ArrayList<Data> entries) {}
              """);
      ...
      // ArrayList implements Collection → TraversalPath
      assertThat(code).contains("TraversalPath");
    }
  ...
  class PathSourceProcessorCapabilityTests {
    ...
    void combinableCapabilityShouldIncludeZipWithButNotVia() throws IOException {
      ...
      // COMBINABLE should have zipWith but NOT via/flatMap
    ...
    void pathSourceWithCustomTargetPackageShouldWork() {
      ...
      assertThat(compilation).succeeded();
      assertThat(compilation)
          .generatedSourceFile("com.example.gen.CustomPath")
          .isNotNull();
    }
  }
  ...
  class ImportOpticsProcessorCopyStrategyTests {
    ...
    void recordWithWitherMethodsShouldWork() {
      ...
      Compilation compilation =
          javac()
              .withProcessors(new ImportOpticsProcessor())
              .compile(externalClass, packageInfo);
    ...
    void sealedInterfaceShouldGeneratePrisms() {
      ...
      assertThat(compilation).succeeded();
      assertThat(compilation)
          .generatedSourceFile("com.myapp.optics.ShapePrisms")
          .isNotNull();
    }
    ...
    void enumShouldGeneratePrisms() {
      ...
      Compilation compilation =
          javac()
              .withProcessors(new ImportOpticsProcessor())
              .compile(color, packageInfo);

      assertThat(compilation).succeeded();
      assertThat(compilation)
          .generatedSourceFile("com.myapp.optics.ColorPrisms")
          .isNotNull();
    }
  }
  ...
  class FoldProcessorIterableDetectionTests {
    ...
    void arrayListFieldShouldGenerateFold() throws IOException {
      ...
      // ArrayList implements Iterable → should generate fold
      assertThat(code).contains("itemsFold");
      assertThat(code).contains("Fold<Container, String>");
    }
    ...
    void setFieldShouldGenerateFold() throws IOException {
      ...
      assertThat(code).contains("numbersFold");
    }
  }
