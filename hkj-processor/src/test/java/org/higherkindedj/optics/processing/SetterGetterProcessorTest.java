...
class SetterGetterProcessorTest {
  ...
  class SetterProcessorTests {
    ...
    void shouldGenerateSettersForSimpleRecord() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("Setter<Point, Integer> x()");
      org.assertj.core.api.Assertions.assertThat(code).contains("Setter<Point, Integer> y()");
      // With methods
      org.assertj.core.api.Assertions.assertThat(code).contains("withX(");
      org.assertj.core.api.Assertions.assertThat(code).contains("withY(");
      // Constructor reconstruction
      org.assertj.core.api.Assertions.assertThat(code).contains("new Point(");
      // Generated annotation
      org.assertj.core.api.Assertions.assertThat(code).contains("@Generated");
    }
    ...
    void shouldGenerateSettersForRecordWithStringField() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("Setter<Name, String> first()");
      org.assertj.core.api.Assertions.assertThat(code).contains("Setter<Name, String> last()");
      org.assertj.core.api.Assertions.assertThat(code).contains("withFirst(");
      org.assertj.core.api.Assertions.assertThat(code).contains("withLast(");
      // Setter getter reference
      org.assertj.core.api.Assertions.assertThat(code).contains("Name::first");
      org.assertj.core.api.Assertions.assertThat(code).contains("Name::last");
    }
    ...
    void shouldGenerateSettersForGenericRecord() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("<A, B>");
      org.assertj.core.api.Assertions.assertThat(code).contains("withFirst(");
      org.assertj.core.api.Assertions.assertThat(code).contains("withSecond(");
    }
    ...
    void withMethodNonGenericCallsSetterDirectly() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("value().set(");
    }
    ...
    void withMethodGenericUsesExplicitTypeArgs() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("BoxSetters.<T>content()");
    }
    ...
    void setterMethodHasFromGetSetPattern() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("Setter.fromGetSet(");
      // Multi-field: second field should use newValue in correct position
      org.assertj.core.api.Assertions.assertThat(code).contains("source.name()");
      org.assertj.core.api.Assertions.assertThat(code).contains("newValue");
    }
  }
  ...
  class GetterProcessorTests {
    ...
    void shouldGenerateGettersForSimpleRecord() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("Getter<Point, Integer> x()");
      org.assertj.core.api.Assertions.assertThat(code).contains("Getter<Point, Integer> y()");
      // Get convenience methods
      org.assertj.core.api.Assertions.assertThat(code).contains("getX(");
      org.assertj.core.api.Assertions.assertThat(code).contains("getY(");
      // Generated annotation
      org.assertj.core.api.Assertions.assertThat(code).contains("@Generated");
    }
    ...
    void shouldGenerateGettersForRecordWithStringField() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("Getter<Name, String> first()");
      org.assertj.core.api.Assertions.assertThat(code).contains("Getter<Name, String> last()");
      org.assertj.core.api.Assertions.assertThat(code).contains("getFirst(");
      org.assertj.core.api.Assertions.assertThat(code).contains("getLast(");
      // Getter reference
      org.assertj.core.api.Assertions.assertThat(code).contains("Getter.of(");
    }
    ...
    void shouldGenerateGettersForGenericRecord() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("<A, B>");
      org.assertj.core.api.Assertions.assertThat(code).contains("getFirst(");
      org.assertj.core.api.Assertions.assertThat(code).contains("getSecond(");
    }
    ...
    void getMethodNonGenericCallsGetterDirectly() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("value().get(source)");
    }
    ...
    void getMethodGenericUsesExplicitTypeArgs() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("BoxGetters.<T>content()");
    }
  }
  ...
  class PrismProcessorEnumTests {
    ...
    void shouldGeneratePrismsForEnum() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("RED");
      org.assertj.core.api.Assertions.assertThat(code).contains("GREEN");
      org.assertj.core.api.Assertions.assertThat(code).contains("BLUE");
    }
    ...
    void shouldGeneratePrismsForSealedInterface() throws IOException {
      ...
      org.assertj.core.api.Assertions.assertThat(code).contains("circle()");
      org.assertj.core.api.Assertions.assertThat(code).contains("square()");
      org.assertj.core.api.Assertions.assertThat(code).contains("instanceof");
      org.assertj.core.api.Assertions.assertThat(code).contains("@Generated");
    }
  }
}
