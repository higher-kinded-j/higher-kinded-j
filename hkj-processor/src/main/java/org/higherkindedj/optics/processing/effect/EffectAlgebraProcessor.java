...
public class EffectAlgebraProcessor extends AbstractProcessor {
  ...
  private void generateKind(String packageName, String baseName, ClassName sourceClass)
      throws IOException {
  ...
  private void generateKindHelper(String packageName, String baseName, ClassName sourceClass)
      throws IOException {
    String kindName = baseName + "Kind";
  ...
  private void generateOps(
      String packageName, String baseName, ClassName sourceClass, List<TypeElement> permits)
      throws IOException {
    String kindName = baseName + "Kind";
    String helperName = baseName + "KindHelper";
    String functorName = baseName + "Functor";
