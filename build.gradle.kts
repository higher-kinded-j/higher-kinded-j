...
allprojects {
  ...
  // version can be set here or in subprojects
}
...
subprojects {
  ...
  configure<com.diffplug.gradle.spotless.SpotlessExtension> {
    ...
    java {
      target("src/**/*.java")
      googleJavaFormat("1.27.0").reflowLongStrings().formatJavadoc(true) // Version from your original file
      removeUnusedImports()
      trimTrailingWhitespace()
      licenseHeaderFile(rootProject.file("config/spotless/copyright.txt"), "(package|import|public|@|module)") //
    }
  }
}
