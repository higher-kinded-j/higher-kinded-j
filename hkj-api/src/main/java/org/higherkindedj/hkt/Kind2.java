 ...
 * <h2>Witness Arity</h2>
 *
 * <p>The witness type {@code F} must implement {@link WitnessArity WitnessArity&lt;TypeArity.Binary&gt;}
 * to declare that it represents a binary type constructor:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * @param <F> The witness type for the type constructor. Must implement
 *     {@link WitnessArity WitnessArity&lt;TypeArity.Binary&gt;}.
