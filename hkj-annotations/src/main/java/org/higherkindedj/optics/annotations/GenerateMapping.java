 ...
 *       EmailAddress>}. It must not itself be a mapping spec, and must not be reached through a raw
 *       supertype, which erases every member it declares. Diagnostics about inherited members name
