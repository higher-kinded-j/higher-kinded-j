 ...
 *   <li>A same-typed container is handed over as a copy in both directions, never as the container
 *       that was read, so the wire and the domain never share one: an unmodifiable copy in the
 ...
 *       a subtype such as {@code ArrayList}, any other interface, a type variable and an element
 *       declared through a wildcard are handed over as they are.
 ...
 *       and parses gets {@code asValidatedPrism()} so it plugs in wherever a leaf does.
