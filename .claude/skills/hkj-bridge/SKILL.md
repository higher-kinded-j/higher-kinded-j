...
| `ValidatedPrism.canonical(message, parse, render)` | `ValidatedPrism<S, A>` | Wrap a throwing parser; render defines the canon, other spellings reject (section law guarded per value) |
